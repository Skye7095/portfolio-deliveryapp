		...
		<section class="container">
			...
			<div class="d-flex mt-3">
				...
				<div class="col-9">
					...
					<span class="font-italic font-weight-bold text-primary">치타배달</span> &nbsp &nbsp 배달팁 0원~1,800원 <br>
