	...
	<div id="wrap">
		...
		<section class="container">
			<div class="text-center my-3">
				...
				<p class="font-bold">${riderList.name }</p>
			</div>
				...
				<button type="button" id="emailUpdateBtn" class="border border-secondary btn btn-lg btn-block btn-light mt-3" data-bs-toggle="button">
					<div class="d-flex justify-content-between align-items-center">
						...
						<div class="d-flex align-items-center">
							<span class="text-secondary" style="font-size:12px">${riderList.email }</span>
			...
			<button type="button" id="identityChangeBtn" class="border border-secondary btn btn-lg btn-block btn-light mt-3" data-bs-toggle="button">
				<div class="d-flex justify-content-between align-items-center">
					<span class="font-weight-bold" id="identityChangeBtn">신분 변경</span>
					<span class="text-secondary"> ></span>
				</div>
			</button>
		</section>
	    ...
	    <div class="modal-content">
	    	<div class="modal-body">
	    		...
	    		<div class="d-flex justify-content-between">
	    			<input type="text" class="form-control mr-1" placeholder="${riderList.email }" id="emailInput">
	  ...
	  <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
	    <div class="modal-content">
	    	<div class="modal-body">
	    		...
	    		<div class="d-flex justify-content-between">
	    			<input type="text" class="form-control mr-1" placeholder="${riderList.phone }" id="phoneInput">
